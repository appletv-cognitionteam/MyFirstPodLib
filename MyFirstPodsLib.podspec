#
#  Be sure to run `pod spec lint MyFirstPodsLib.podspec' to ensure this is a
...
Subtraction of given two integers.
  ...
  spec.author             = { "Mahesh Dhapa" => "mahesh@cognitionteam.com" }
  # Or just: spec.author    = "Mahesh Dhapa"
  # spec.authors            = { "Mahesh Dhapa" => "mahesh@cognitionteam.com" }
  # spec.social_media_url   = "https://twitter.com/Mahesh Dhapa"
